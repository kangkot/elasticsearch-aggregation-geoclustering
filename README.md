...
`bin/plugin --install geo_clustering_aggregation --url "https://github.com/opendatasoft/elasticsearch-aggregation-geoclustering/releases/download/V1.0.1/elasticsearch-geoclustering-aggregation-1.0.1.zip"`
